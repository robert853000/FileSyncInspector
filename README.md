...
FileSyncInspector je jednoduchá a pøehledná desktopová aplikace pro Windows, která slouží k porovnávání dvou složek na pevném disku nebo jiném úložišti.  

Je navržena pro snadné ovìøení, že kopírování souborù mezi dvìma místy probìhlo správnì a bez ztráty dat.



Aplikace zkontroluje nejen pøítomnost všech souborù a složek, ale také bitovou shodu souborù, aby se odhalily pøípadné poškozené, chybìjící nebo zmìnìné soubory.
